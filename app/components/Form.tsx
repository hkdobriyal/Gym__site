...
//   return (
//     <section id="form">
//       <div className="max-w-xl my-16 mx-8 lg:mx-auto p-8 lg:px-12 lg:py-16 bg-black text-white space-y-10 rounded-xl shadow-lg">
...
//                 className="py-3 px-4 text-black rounded-lg border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-[#ff0336]"
//               />
//             </div>
//           )}
//           <div className="flex flex-col gap-3">
...
//         </div>
//         <div>
//           <button className="bg-[#ff0336] p-3 text-center text-lg w-full rounded-lg shadow-md border-2 border-[#ff0336] transition-all duration-300 hover:bg-transparent hover:text-[#ff0336] hover:border-[#ff0336]">
//             {register ? "Register" : "Login"}
//           </button>
//         </div>
//         <div className="flex flex-col gap-3 items-center">
//           <p className="text-gray-300">{register ? "Already have an account?" : "New to M&H?"}</p>
//           <Link
//             href={register ? "/login" : "/register"}
//             className="text-[#ff0336] font-bold transition-all duration-300 hover:underline hover:text-red-500"
//           >
